...
import TBTTable5Modal from "./TBTTable5Modal";
          ...
          if (
            ...
            return (
              <TableCell
                ...
                key={index + header}
                align={header === "sSignature" ? "center" : "left"} 
                padding="normal"
              >
                {header?.slice(1)} 
              </TableCell>
...
export default function TBTTable5({ data, handleChildData }) {
