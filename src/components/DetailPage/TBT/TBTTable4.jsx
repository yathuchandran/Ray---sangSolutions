...
import TBTTable4Modal from "./TBTTable4Modal";
    ...
    >
      <TableRow>
        ...
        {rows.map((header, index) => {
          if (header !== "iTransId" && header !== "iTransDtId") {
...
export default function TBTTable4({ data, handleChildData }) {
