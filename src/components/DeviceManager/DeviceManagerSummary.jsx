...
import { getApproveDevice, getDeviceSummary } from "../../api/deviceMangerApi";
...
export default function DeviceManagerSummary() {
  ...
  return (
    ...
    >
      Device Manager
              ...
              {renderButton(5, "Approve", () => handleApprove(1), <DoneIcon />,selected.length === 0)} 
      {renderButton(6, "Reject", () => handleApprove(2), <DoDisturbIcon />, selected.length === 0)}
