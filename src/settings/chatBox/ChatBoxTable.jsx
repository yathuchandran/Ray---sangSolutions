...
const columnOrder = [
  { id: 'sStartDate', label: 'Start Date' },
  { id: 'sEndDate', label: 'End Date' },
  { id: 'sSubject', label: 'Subject' },
...
export default function EnhancedTable(props) {
  ...
  React.useEffect(() => {
    props.onSearchKeyChange(searchTerm);
                  ...
                  >
                    ...
                    {columnOrder.map((column) => (
                      <TableCell
                        ...
                        key={column.id}
                        align={column.id === "sEmployeePhoto" || column.id === "sLocation" ? "center" : "left"}
                      >
                        {column.id === "sEmployeePhoto" ? (
                          row.sEmployeePhoto ?(<img
                            src={row.sEmployeePhoto}
                            alt="Employee"
                            style={{ height: "30px", width: "auto" }} // Adjust the size as needed
                          ...
                          row.sMonth === 0 ? (
                            `Best Performer of other year - ${row.iYear}`
                          ) : (
                            `${row.sMonth}-${row.iYear}`
                          )
                        ) : (
                          row[column.id]
                        )}
