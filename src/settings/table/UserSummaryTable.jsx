...
function EnhancedTableHead(props) {
  ...
  // Filter out keys "totalRows" and "iId"
  const filteredHeadCells = headCells.filter(key => key !== "totalRows" && key !== "iId" && key !== "sPassword");
  return (
    <TableHead>
      {filteredHeadCells && filteredHeadCells.length > 0 ? (
        ...
        <TableRow>
          ...
          {Object.keys(filteredHeadCells[0])
            .filter(
              (key) =>
                !["totalRows", "iId","sPassword"].includes(
                  key
                )
            )
            .map((key) => (
              ...
              >
                {key === "sLoginName" ? "Login Name" :
                                      key === "sUserName" ? "User Name" :
                                        key === "sPhoneNo" ? "Phone No" :
                                        key === "sEmail" ? "Email" :
                                        key === "sRoleName" ? "Role Name" :
                                        key === "sCreatedBy" ? "Created By" :
                                        key === "sCreatedDate" ? "Created Date" :
                                          key}
              </TableCell>
            ))}
        </TableRow>
              ...
              {filteredRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {Object.keys(row)
                      .filter((key) => key !== "totalRows" && key !== "iId"&& key !=="sPassword" ) // Exclude sPath from the keys
                      .map((key, idx) => (
                        <TableCell
                          sx={{
                            padding: "0px",
