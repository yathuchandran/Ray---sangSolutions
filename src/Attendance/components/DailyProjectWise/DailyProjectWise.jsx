...
function DailyProjectWiseReport() {
  ...
  const columnOrder = [
    ...
    // { id: 'DailyBreakHour', label: 'Daily BreakHour' },
    // { id: 'TotalHour', label: 'Total Hour' },
    
  ];
  const excelHeaders = [
    'Date', 'Project', 'Employee', 'EmployeeCode', 'CheckIn', 'CheckOut', 'Hours','DailyBreakHour','TotalHour'
  ];
  ...
  if (fromDate > today || toDate > today) {
    ...
    try {
      ...
      const response = await DailyProjectReport({
        displayLength,
        displayStart,
        FromDate,
        ToDate,
...
export default DailyProjectWiseReport;
